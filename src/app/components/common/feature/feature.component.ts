...
export class FeatureComponent implements AfterViewInit {
  ...
  @ViewChildren('vimeoPlayerContainer')
  vimeoPlayerContainers!: QueryList<ElementRef>;
  ...
  constructor(private router: Router, private cdr: ChangeDetectorRef) {
    ...
    this.classroom = 'segments'; //Link
    this.cards = [
      {
        title: 'Class Room',
        content:
          'In class, you will learn what spoken Hindi is and how sentences are formed.',
      ...
      },
      {
        title: 'Speaking Room',
        content:
          'Practice with Co-learners along with the Master on our great platform',
