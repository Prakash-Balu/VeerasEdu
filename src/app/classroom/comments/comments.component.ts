...
@Component({
  ...
  standalone: true,
  imports: [ CommonModule, FormsModule, MatCardModule, MatTabsModule, MatPaginatorModule, MatIconModule, NgxEditorModule],
  templateUrl: './comments.component.html',
  styleUrl: './comments.component.css',
})
export class CommentsComponent {
  @Input() classroomObj: { _id?: string } = {};
  editor!: Editor;
  constructor(
  ...
  ngOnInit(): void {
    ...
    if (this.authService.tokenValue) {
      ...
      this.route.paramMap.subscribe((params: ParamMap) => {
        ...
        this.segmentId = this.classroomObj._id;
        // this.segmentId = 1;
