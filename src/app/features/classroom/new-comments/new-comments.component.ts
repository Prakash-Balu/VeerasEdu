  ...
  commentsList = [
    {
      ...
      time: '30 minutes ago',
      message:
        'Can someone explain the difference between `ngIf` and `hidden` in Angular?',
      replies: [],
    },
    {
      name: 'Anand Iyer',
      ...
      replies: [
        {
          ...
          message:
            'Use the new `loadComponent()` syntax for better tree-shaking and lazy loading performance.',
        },
      ],
    },
    {
      ...
      time: '2 hours ago',
      message:
        'I’m trying to create a dynamic form array. Anyone got a simple example?',
      replies: [],
      ...
      replies: [
        {
          ...
          avatar: 'assets/images/logo_icon.png',
          message:
            'Yes, you can use NGXS DevTools or integrate it with Redux DevTools for real-time tracking.',
        },
      ],
